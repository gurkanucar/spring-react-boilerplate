...
/**
 * Persistence representation of the scheduled-event aggregate — the driven-side JPA entity. It mirrors
 * the {@link com.gucardev.springreactboilerplate.features.scheduledevent.domain.model.ScheduledEvent
...
@NoArgsConstructor
@AllArgsConstructor
public class ScheduledEventJpaEntity extends BaseEntity {
     ...
     * what to cast values to). The listener branches on this — see {@code ProcessScheduledEventService}.
     */
