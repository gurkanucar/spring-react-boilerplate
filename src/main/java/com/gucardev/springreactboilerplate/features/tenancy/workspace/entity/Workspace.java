package com.gucardev.springreactboilerplate.features.tenancy.workspace.entity;
...
/**
 * A workspace within an {@link com.gucardev.springreactboilerplate.features.tenancy.organization.entity.Organization}.
 * {@code organizationId} is the tenant discriminator: every workspace query is scoped to the
 * caller's organization (see {@code WorkspaceFinder}).
 */
@Entity
