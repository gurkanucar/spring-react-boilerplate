package com.gucardev.springreactboilerplate.features.core.auth.application.exception;
 ...
 * Throw via a constant, e.g. {@code throw AuthExceptionType.INVALID_REFRESH_TOKEN.toException();}
 */
